...
insert into @firstnames values ('James'),('John'),('Robert'),('Michael'),('Mary'),('William'),('David'),('Richard'),('Charles'),('Joseph'),('Thomas'),('Patricia')
,('Christopher'),('Linda'),('Barbara'),('Daniel'),('Paul'),('Mark'),('Elizabeth'),('Jennifer'),('Maria'),('Susan'),('Margaret'),('Dorothy'),('Lisa'),('Nancy'),('Karen')

insert into @lastnames values ('Smith'),('Johnson'),('Williams'),('Jones'),('Brown'),('Davis'),('Miller'),('Wilson'),('Moore'),('Taylor'),('Anderson'),('Thomas'),('Jackson')
,('White'),('Harris'),('Martin'),('Thompson'),('Garcia'),('Martinez'),('Robinson')

declare @firmnames table (name varchar(50))

insert into @firmnames (name) values ('Acme, inc.'),('Widget Corp'),('123 Warehousing'),('Demo Company'),('Smith and Co.'),('Foo Bars'),('ABC Telecom'),('Fake Brothers')
,('QWERTY Logistics'),('Demo, inc.'),('Sample Company'),('Sample, inc'),('Acme Corp'),('Allied Biscuit'),('Ankh-Sto Associates'),('Extensive Enterprise'),('Galaxy Corp')
,('Globo-Chem'),('Mr. Sparkle'),('Globex Corporation'),('LexCorp'),('LuthorCorp'),('North Central Positronics'),('Omni Consimer Products'),('Praxis Corporation'),('Sombra Corporation')
,('Sto Plains Holdings'),('Tessier-Ashpool'),('Wayne Enterprises'),('Wentworth Industries'),('ZiffCorp'),('Bluth Company')

declare @cities table (name varchar(50))

insert into @cities (name) values ('California City'),('Calimesa'),('Canyon Lake'),('Berkeley'),('San Francisco'),('Davis'),('Chico'),('Cloverdale'),('Clovis')
,('Colfax'),('Colton')

declare @jobtitles table (name varchar(50))

insert into @jobtitles (name) values ('CEO'),('CFO'),('CIO'),('Head Produce Guy'),('Head Cattleman'),('VP Produce'),('VP Strawberries'),('President Operations')
,('VP Produce Safety'),('VP Cow Patties'),('VP Chicken Farms'),('President of Corn')
...
begin
	...
	*/
	...
	insert into applications(firstname, lastname, firmname, firmaddressline1, firmcity
							, firmstate, firmzip, firmphone, responsibilities, jobtitle, userid, seminarid)
	values (@firstname, @lastname, @firmname, @line1, @city, @state, @zip, @phone, @responsibilities, @jobtitle, @userid, 51)
